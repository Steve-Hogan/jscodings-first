...
// Output Format
// If the person is eligible to vote, return "Eligible for Voting" otherwise,
// return "Not Eligible for Voting" (without quotes).
...
// Input Format
// The first and the only line of the input contains two space-separated integers X and Y
...
// Input Format
// The first and the only line of the input contains an integer M, representing the marks that 
// your friend will enter in the grading system.
...
// Input Format
// The first and the only line of the input contains a character C, representing
// the character that you will get in input.
...
//   Second Smallest
// You are given 3 distinct integers X,Y, and Z, and your task is to find and return 
...
// Input Format
// The first and the only line of the input contains three space-separated integers X, Y, and Z
